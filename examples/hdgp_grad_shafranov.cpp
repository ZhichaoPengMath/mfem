...
//
// -( rq, v)       + (u, div(v))       - <\lambda, v \cdot n>      = 0
...
int main(int argc, char *argv[])
{
   ...
   diff = 1.;
   /* rFun = r = x */
   FunctionCoefficient diffusion(rFun_ex); // diffusion constant
//   ConstantCoefficient diffusion(rFun_ex); // diffusion constant
   double tau_D = 5.0;
